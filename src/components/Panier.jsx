...
export default function Panier({ items, onUpdateQty, onRemove, onClose, onConfirm, isMobile }) {
  ...
  return (
    <div style={{
      ...
      background: 'rgba(26,58,42,0.50)', backdropFilter: 'blur(4px)',
      ...
      <div style={{
        ...
        boxShadow: '0 -8px 40px rgba(26,58,42,0.20)',
            ...
            <div style={{ paddingTop: 16 }}>
              {items.map((item, idx) => (
                <div key={idx} style={{
                  ...
                  padding: '12px 0', borderBottom: `1px solid rgba(184,148,63,0.12)`,
                }}>
