...
// ─── Couleurs marque Le Centre ───────────────────────────────
const C = {
  primary:     '#1A3A2A',
  primaryMid:  '#2D5E42',
  primarySoft: 'rgba(26,58,42,0.08)',
  gold:        '#B8943F',
  goldLight:   '#D4AF6A',
  beige:       '#F5EDD8',
  cream:       '#FBF8F0',
  ...
  danger:      '#C0392B',
  warning:     '#D4891A',
  goldDeep:    '#83692D', // high-contrast accent for text on white/cream backgrounds
  ...
  warningDark: '#946012', // high-contrast amber for text on light backgrounds
};
...
function CommandesTab() {
  ...
  const badgeStyle = (statut) => ({
    recue:     { bg: `rgba(184,148,63,0.15)`, color: C.goldDeep },
          ...
          {filtered.map(cmd => {
            ...
            return (
              <div key={cmd.id} style={{
                ...
                border: `1px solid ${C.border}`, boxShadow: `0 2px 10px rgba(26,58,42,0.06)`,
...
function ProduitsTab() {
  ...
  return (
    <div>
      ...
      {form && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(26,58,42,0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: 32, width: '100%', maxWidth: 480, boxShadow: '0 20px 60px rgba(26,58,42,0.2)' }}>
...
function CategoriesTab() {
  ...
  return (
    <div>
      ...
      {form && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(26,58,42,0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: 32, width: '100%', maxWidth: 400, boxShadow: '0 20px 60px rgba(26,58,42,0.2)' }}>
            <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 22, color: C.primary, marginBottom: 24 }}>
...
function ParametresTab() {
  ...
  const cardStyle  = { background: '#fff', borderRadius: 16, border: `1px solid ${C.border}`, boxShadow: `0 2px 10px rgba(26,58,42,0.06)`, padding: 24, marginBottom: 20 };
    ...
    <div>
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <input value={nomRestaurant} onChange={e => setNom(e.target.value)} style={{ ...inputStyle, flex: 1, minWidth: 200 }} placeholder="Le Centre" />
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: C.cream }}>
      ...
      <aside style={{
        ...
        boxShadow: '4px 0 24px rgba(26,58,42,0.18)',
      }}>
        {/* Header sidebar */}
        <div style={{ padding: '0 24px 24px', borderBottom: `1px solid rgba(184,148,63,0.18)`, marginBottom: 12 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 20, color: C.beige, fontWeight: 700, lineHeight: 1.2 }}>Le Centre</h2>
